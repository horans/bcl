...
// @author       horan
// @match        https://getbootstrap.com/*customize/*
// @match        https://v3.bootcss.com/customize/*
// @require      //code.jquery.com/jquery-3.6.0.min.js
// @grant none
// @changelog    update match urls; eslint compatible.
// ==/UserScript==
/* global $ */
$(document).ready(function () {
  ...
  function l (e, s, t) {
    // h2, block title
    if (t === 2) {
      $('#' + e.toLowerCase().replace(' ', '-')).append(
        ' <small>' + s + '</small>'
      )
      // input, deprecated
    } else if (t === 3) {
      $('*[id="input-@' + e + '"]').after(
        '<p class="help-block"><del>' + s + '</del></p>'
      )
      // input, default
    } else {
